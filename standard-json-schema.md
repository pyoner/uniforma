...
url: https://standardschema.dev/json-schema
date: "2026-03-24T05:35:21.286Z"
generator: Webpage to Markdown
---

![Standard Schema fire logo](/favicon.svg)
...
[Go to repo](https://github.com/standard-schema/standard-schema)
...
## [Who designed it?](#who-designed-it)
...
## [What schema libraries support this spec?](#what-schema-libraries-support-this-spec)
...
### [GraphQL Standard Schema](#graphql-standard-schema)
...
## [What tools / frameworks accept spec-compliant schemas?](#what-tools-frameworks-accept-speccompliant-schemas)
...
### [What's the relationship between this and _Standard Schema_?](#whats-the-relationship-between-this-and-standard-schema)
...
### [Why multiple `target` values?](#why-multiple-target-values)
...
### [Does the spec account for future versions of JSON Schema?](#does-the-spec-account-for-future-versions-of-json-schema)
...
### [What's `"openapi-3.0"`?](#whats-openapi30)
...
### [Why both `jsonSchema.input` and `jsonSchema.output`?](#why-both-jsonschemainput-and-jsonschemaoutput)
...
### [Why is this a separate spec instead of adding to `StandardSchemaV1`?](#why-is-this-a-separate-spec-instead-of-adding-to-standardschemav1)
...
### [I'm a schema library author. How do I implement this spec?](#im-a-schema-library-author-how-do-i-implement-this-spec)
...
### [I want to accept JSON Schema from a user. How do I do that?](#i-want-to-accept-json-schema-from-a-user-how-do-i-do-that)
...
### [What if I want to accept only schemas that implement both `StandardSchema` and `StandardJSONSchema`?](#what-if-i-want-to-accept-only-schemas-that-implement-both-standardschema-and-standardjsonschema)
...
by [@colinhacks](https://twitter.com/colinhacks), [@fabianhiller](https://twitter.com/fabianHiller), and [@ssalbdivad](https://twitter.com/ssalbdivad)
