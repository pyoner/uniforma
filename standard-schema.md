...
url: https://standardschema.dev/schema
date: "2026-03-24T06:05:48.425Z"
...
## [What schema libraries implement the spec?](#what-schema-libraries-implement-the-spec)
...
### [Do I need to add `@standard-schema/spec` as a dependency?](#do-i-need-to-add-standardschemaspec-as-a-dependency)
...
### [Can I add it as a dev dependency?](#can-i-add-it-as-a-dev-dependency)
...
### [Why did you prefix the `~standard` property with `~`?](#why-did-you-prefix-the-standard-property-with-)
...
### [Why not use a symbol key?](#why-not-use-a-symbol-key)
...
### [How to only allow synchronous validation?](#how-to-only-allow-synchronous-validation)
